...
const House = ({ house }) => {
  ...
  return (
    <div className='bg-white shadow-1 p-5 rounded-lg
      rounded-tl-[90px] w-full max-w-[252px] mx-auto
      ...
      <div className='mb-4 flex gap-x-2 text-sm'>
          ...
          <div className='bg-violet-600 rounded-full text-white px-3'>{country}</div>
      </div>
      <div className='text-lg font-semibold max-w-[150px]'>
        {address}
      </div>
